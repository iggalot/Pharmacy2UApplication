...
namespace Dna
{
    ...
    public static class Framework
    {
        ...
        /// <summary>
        /// Should be called once a FrameworkConstruction is finished and we want to build it and 
        ...
        public static void Build(this FrameworkConstruction construction)
        {
            ...
            Logger.LogCritical($"Dna Framework started in {Environment.Configuration}... ");
        }
