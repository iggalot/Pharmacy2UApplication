    ...
    public class WindowResizer
    {
        ...
        private void WmGetMinMaxInfo(System.IntPtr hwnd, System.IntPtr lParam)
        {
            ...
            CurrentMonitorMargin = new Thickness(
                (lCurrentScreenInfo.RCWork.Left - lCurrentScreenInfo.RCMonitor.Left),
                (lCurrentScreenInfo.RCWork.Top - lCurrentScreenInfo.RCMonitor.Top),
                (lCurrentScreenInfo.RCMonitor.Right - lCurrentScreenInfo.RCWork.Right),
                (lCurrentScreenInfo.RCMonitor.Bottom - lCurrentScreenInfo.RCWork.Bottom)
                );
